...
exist, centered to the parent node containing it. Note that as of
`paper-tooltip#2.0.0`, you must explicitely include the `web-animations`
polyfill if you want this element to work on browsers not implementing the
WebAnimations spec. Example:
    // polyfill
